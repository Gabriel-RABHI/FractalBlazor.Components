...
/// </summary>
public sealed class FbGridItem : FbComponentBase
{
    [Parameter]
    ...
    [Parameter]
    public FbGridItemAlignment AlignSelf { get; set; } = FbGridItemAlignment.Auto;

    [Parameter]
    public FbGridItemAlignment JustifySelf { get; set; } = FbGridItemAlignment.Auto;
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
        ...
        builder.AddAttribute(2, "class", string.IsNullOrWhiteSpace(Classes) ? "fb-grid-item" : $"fb-grid-item {Classes.Trim()}");
